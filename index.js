...
io.on('connection', (socket) => {
  ...
  socket
    .to(cursors[socket.id].currentRoom)
    .emit('allCursors', [cursors, polygons[cursors[socket.id].currentRoom], gifs[cursors[socket.id].currentRoom]]);
